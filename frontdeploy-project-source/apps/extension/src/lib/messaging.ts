...
export type PageToBridgeMessage =
  ...
  | { type: "wallet-sign-send-request"; id: string; provider: "phantom" | "solflare" | "backpack"; txsBase64: string[]; rpcUrls: string[] };
...
export type BridgeToPageMessage =
  ...
  | { type: "wallet-sign-send-response"; id: string; success: boolean; signatures?: string[]; error?: string };
...
export type RelayToBackgroundMessage =
  ...
  | { type: "RELAY_SIGN_SEND_RESPONSE"; id: string; success: boolean; signatures?: string[]; error?: string };
...
export type BackgroundToRelayMessage =
  ...
  | { type: "BACKGROUND_SIGN_SEND_REQUEST"; id: string; provider: "phantom" | "solflare" | "backpack"; txsBase64: string[]; rpcUrls: string[] };
